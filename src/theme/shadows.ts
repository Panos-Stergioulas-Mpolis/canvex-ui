...
const transparent4 = alpha(palette.grey[500], 0.16);
...
export const customShadows = {
  z1: `0 1px 2px 0 ${transparent4}`,
  z8: `0 8px 16px 0 ${transparent4}`,
  z12: `0 12px 24px -4px ${transparent4}`,
  z16: `0 16px 32px -4px ${transparent4}`,
  z20: `0 20px 40px -4px ${transparent4}`,
  z24: `0 24px 48px 0 ${transparent4}`,
